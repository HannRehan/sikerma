...
$jscomp.IS_SYMBOL_NATIVE = "function" === typeof Symbol && "symbol" === typeof Symbol(
    "x"
);
...
$jscomp.polyfillIsolated = function (k, y, z, q) {
    ...
    G = G[G.length - 1];
    z = $jscomp.IS_SYMBOL_NATIVE && "es6" === z
        ? q[G]
        : null;
    y = y(z);
    null != y && (
...
function G(a) {
            ...
            k.each(a, function (e, f) {
                (b = e.match(/^([^A-Z]+?)([A-Z])/)) && -1 !== "a aa ai ao as b fn i m o s ".indexOf(
                    b[1] + " "
                ) && (
        ...
        function ma(a) {
            ...
            if (a) {
                ...
                !a.sEmptyTable && d && "No data available in table" === b.sEmptyTable && V(
                    a,
                    a,
                    "sZeroRecords",
                    "sEmptyTable"
                );
                !a.sLoadingRecords && d && "Loading..." === b.sLoadingRecords && V(
                    a,
                    a,
                    "sZeroRecords",
                    "sLoadingRecords"
        ...
        function Ab(a) {
            if (!u.__browser) {
                ...
                var c = k("<div/>")
                        ...
                        .append(
                            k("<div/>").css({position: "absolute", top: 1, left: 1, width: 100, overflow: "scroll"}).append(k("<div/>").css({width: "100%", height: 10}))
                        )
                        .appendTo("body"),
                    d = c.children(),
                    e = d.children();
        ...
        function S(a, b, c, d) {
            ...
            if (l === q) 
                return a.iDrawError != e && null === h && (
                    aa(a, 0, "Requested unknown parameter " + (
...
- 1 != d && c === q && a.splice(d, 1)
        ...
        function $a(a, b, c, d) {
                ...
                t = function (x) {
                    if (c === q || c === h) 
                        ...
                        l = x
                            ...
                            .trim(),
                        g && g._bAttrSrc
                            ? (da(g.mData._)(d, l), p(g.mData.sort, x), p(g.mData.type, x), p(
                                g.mData.filter,
                                x
                            ))
                            : m
            ...
            if (f) 
                ...
                for (e = b.anCells, f = 0, v = e.length; f < v; f++) 
                    t(e[f]);
        (
                b = b.firstChild
                    ? b
                    : b.nTr
            ) && (b = b.getAttribute("id")) && da(a.rowId)(d, b);
        ...
        function La(a, b, c) {
            ...
            a.fnServerData
                ? a
                    .fnServerData
                    .call(g, a.sAjaxSource, k.map(b, function (m, p) {
        ...
        function Fb(a) {
            return a.bAjaxDataGet
                ? (a.iDraw++, U(a, !0), La(a, Ob(a), function (b) {
                    Pb(a, b)
                }), !1)
                : !0
        }
        function Ob(a) {
            ...
            for (l = 0; l < c; l++) {
                ...
                m("mDataProp_" + l, n);
                d.bFilter && (m("sSearch_" + l, v.sSearch), m("bRegex_" + l, v.bRegex), m(
                    "bSearchable_" + l,
                    t.bSearchable
                ));
        ...
        function Ma(a, b) {
            a = k.isPlainObject(a.ajax) && a.ajax.dataSrc !== q
                ? a.ajax.dataSrc
                : a.sAjaxDataProp;
            return "data" === a
                ? b.aaData || b[a]
        ...
        function U(a, b) {
            a.oFeatures.bProcessing && k(a.aanFeatures.r).css(
                "display",
                b
                    ? "block"
                    : "none"
            ...
            l = k("<div/>", {"class": f.sScrollWrapper})
                .append(
                    k("<div/>", {"class": f.sScrollHead}).css({
                        ...
                        width: c.sXInner || "100%"
                    }).append(l.removeAttr("id").css("margin-left", 0).append(
                        "top" === h
                            ? g
                            : null
                    ).append(b.children("thead"))))
                )
                .append(k("<div/>", {"class": f.sScrollBody}).css({
                    position: "relative",
                    overflow: "auto",
                    width: d
                        ? K(d)
            ...
            m && l.append(k("<div/>", {"class": f.sScrollFoot}).css({
                ...
                width: d
                    ? d
                        ...
                        : null
                    : "100%"
            }).append(k("<div/>", {"class": f.sScrollFootInner}).append(n.removeAttr("id").css("margin-left", 0).append(
                "bottom" === h
                    ? g
                    : null
        ...
        function Ea(a) {
            ...
            if (a.scrollBarVis !== ha && a.scrollBarVis !== q) 
                ...
                r.outerWidth() < f
                    ? (
                        la = h.scrollHeight > h.offsetHeight || "scroll" == m.css("overflow-y")
                            ? f + b
                            : f,
                        M && (h.scrollHeight > h.offsetHeight || "scroll" == m.css("overflow-y")) && (
                            E.width = K(la - b)
                        ),
        ...
        function Xa(a) {
            ...
            if (d || !t && !f && !e && h == na(a) && h == n.length) 
                ...
                h
                    ...
                    .remove();
                h
                    .append(k(a.nTHead).clone())
                    .append(k(a.nTFoot).clone());
                h
                ...
                for (v = 0; v < l.length; v++) 
                    r = c[l[v]],
                    n[v].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig
                        ? K(r.sWidthOrig)
                        : "",
                    r.sWidthOrig && f && k(n[v]).append(
        ...
        function Pa(a) {
            ...
            if (e.bSort && e.bSortClasses) {
                ...
                for (f = b.length; e < f; e++) {
                    var g = b[e].src;
                    k(T(a.aoData, "anCells", g)).removeClass(c + (
                        2 > e
                            ? e + 1
                            : 3
                    ))
                ...
                for (f = d.length; e < f; e++) 
                    g = d[e].src,
                    k(T(a.aoData, "anCells", g)).addClass(c + (
                        2 > e
                            ? e + 1
                            : 3
                    ))
        ...
        var u = function (a) {
            ...
            this.api = function (f) {
                return f
                    ? new D(Ra(this[L.iApiIndex]))
                    : new D(this)
            };
            this.fnAddData = function (f, g) {
                var h = this.api(!0);
                f = Array.isArray(f) && (Array.isArray(f[0]) || k.isPlainObject(f[0]))
                    ? h
                        .rows
                        .add(f)
                    : h
            ...
            this.each(function () {
                    ...
                    if ("table" != this.nodeName.toLowerCase()) 
                        ...
                        f = function () {
                            ...
                            r.nTBody = B[0];
                            B = p.children("tfoot");
                            0 === B.length && 0 < C.length && ("" !== r.oScroll.sX || "" !== r.oScroll.sY) && (
            ...
            return e.length || d
                ? (a = new D(
                    ...
                    a
                        ? e.concat.apply([], e)
                        : e
                ), b = a.selector, b.rows = n.rows, b.cols = n.cols, b.opts = n.opts, a)
                : this
        },
    ...
    var xc = function (a, b, c, d) {
        ...
        wb = function (a, b) {
            var c = a.context;
            c.length && (a = c[0].aoData[
                b !== q
                    ? b
                    : a[0]
            ]) && a._details && (a._details.remove(), a._detailsShow = q, a._details = q)
        },
        pc = function (a, b) {
            var c = a.context;
            c.length && a.length && (a = c[0].aoData[a[0]], a._details && (
                (a._detailsShow = b)
    ...
    u.isDataTable = u.fnIsDataTable = function (a) {
        ...
        k.each(u.settings, function (d, e) {
            d = e.nScrollHead
                ? k("table", e.nScrollHead)[0]
                : null;
            var f = e.nScrollFoot
                ? k("table", e.nScrollFoot)[0]
                : null;
        ...
        header: {
            _: function (a, b, c, d) {
                k(a.nTable).on("order.dt.DT", function (e, f, g, h) {
                    a === f && (e = c.idx, b.removeClass(d.sSortAsc + " " + d.sSortDesc).addClass(
                        "asc" == h[e]
                            ? d.sSortAsc
                            : "desc" == h[e]
                                ? d.sSortDesc
