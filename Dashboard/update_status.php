...
$kategori = mysqli_real_escape_string($conn, $_POST['kategori']);
       ...
       // Nomor MOU dari input form
        $no_mou = mysqli_real_escape_string($conn, $_POST['no_mou']);
    ...
    $end_date = mysqli_real_escape_string($conn, $_POST['end_date']);
        ...
        $updateSql = "UPDATE form SET status = '$status', moa_file = '$moaFileName', mou_file = '$mouFileName', no_mou = '$no_mou', kategori = '$kategori', start_date = '$start_date', end_date = '$end_date' WHERE id_usulan = $id";
        ...
        if (mysqli_query($conn, $updateSql)) {
            ...
            header("Location: ProsesUsulan.php");
            exit;
        } else {
...
<!-- endnavbar -->
    ...
    <input type="checkbox" id="status" name="status" value="1" checked disabled>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <select class="form-select" aria-label="Default select example" type="select" name="kategori" required>
...
<!-- Tambahkan form field untuk nomor MOU -->
<label for="no_mou">Nomor MOU:</label>
<input type="text" name="no_mou" class="form-control" required><br>
