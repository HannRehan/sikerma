...
<!-- endnavbar -->
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <a href='update_status.php?id=" . $row["id_usulan"] . "' class='btn btn-primary'>Edit</a>
        </td>";
            echo "</tr>";
            ...
            echo "<a href='hapus_data.php?id=" . $row["id_usulan"] . "&return=ProsesUsulan.php' class='btn btn-danger'>Hapus</a>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    $(document).ready(function () {
        $("#searchInput").on("keyup", function () {
            ...
            $.ajax({
                type: "POST",
                url: "search_data.php", // Ganti dengan nama file yang akan menangani pencarian
