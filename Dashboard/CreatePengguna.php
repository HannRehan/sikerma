...
<body>
    ...
    <div class="form-check">
        <label>Role</label>
        <div>
            <input class="form-check-input" type="radio" name="role" id="pengusul" value="user">
    ...
    <a class="btn btn-danger" href="../Dashboard/Pengguna.php">CANCEL</a>
</form>
    </div>
</div>
		</main>
    ...
    function redirectToPengguna() {
        ...
        window.location.href = '../Dashboard/Pengguna.php';
        return true;
    }
