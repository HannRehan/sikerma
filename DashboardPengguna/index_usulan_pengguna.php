...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //     echo "Data berhasil disimpan!, Silahkan lihat di Proses Usulan";
    // } else {
...
if (mysqli_query($conn, $sql)) {
    ...
    header("Location: index_usulan_pengguna.php?success=true");
    // var_dump($_POST);
    exit;
} else {
    echo "Error: " . $sql . "<br>" . mysqli_error($conn);
...
<!-- endnavbar -->
    ...
    <input type="checkbox" id="status" name="status" value="1" checked disabled>
            ...
            <a href="../DashboardPengguna/index_pengguna.php" class="btn btn-danger">
            CANCEL
            </a>
            </div>
